...
class EyeosSharingManager extends SharingManager implements ISharingManager {	
	...
	public function getAllShareInfoFromCollaborator(AbstractEyeosPrincipal $collaborator, AbstractEyeosUser $owner = null, $classType = null) {
		return parent::getAllShareInfoFromCollaborator($collaborator, $owner, $classType);
	}
	
	public function notifyShareableObjectdDeleted(IShareable $object) {
		return parent::notifyShareableObjectDeleted($object);
	}
	
	public function notifyShareableObjectUpdated(IShareable $object, AbstractEyeosUser $oldOwner = null) {
		return parent::notifyShareableObjectUpdated($object, $oldOwner);
	}
	
	public function removeCollaborator(IShareable $object, AbstractEyeosPrincipal $collaborator) {
		return parent::removeCollaborator($object, $collaborator);
	}
