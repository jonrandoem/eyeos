 ...
 * @subpackage Meta
 */
class DefaultWorkgroupConfFileMetaHandler implements IMetaDataHandler {
	...
	public function deleteMeta($object, $params) {
		if (!$object instanceof EyeWorkgroupConfFile) {
			throw new EyeInvalidArgumentException('$object must be an EyeWorkgroupConfFile.');
		}
