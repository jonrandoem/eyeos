...
/**
 * This class controls access to users metadata and prevent any WRITE
 * operation if the given $principal is not the owner of the metadata.
 * 
 * @package kernel-services
 * @subpackage Security
 */
class EyeosUserMetaDataSecurityHandler implements ISecurityHandler {
	/**
