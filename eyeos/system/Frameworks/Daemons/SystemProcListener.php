 ...
 * @subpackage Sharing
 */
class SystemProcListener extends AbstractProcAdapter {
	...
	public function processKilled(ProcEvent $e) {
		...
		$message = new ClientBusMessage('application', 'stop', $e->getSource()->getAttributesMap());
	...
	public static function getInstance() {
		if (self::$Instance === null) {
			self::$Instance = new SystemProcListener();
		}
...
ProcManager::getInstance()->addListener(SystemProcListener::getInstance());
?>