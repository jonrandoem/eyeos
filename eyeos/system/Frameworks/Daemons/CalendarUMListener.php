 ...
 * @subpackage Daemons
 */
class CalendarUMListener extends AbstractUMAdapter {
	...
	public static function getInstance() {
		if ( self::$Instance === null) {
			self::$Instance = new CalendarUMListener();
		}
...
UMManager::getInstance()->addUMListener(CalendarUMListener::getInstance());
?>
