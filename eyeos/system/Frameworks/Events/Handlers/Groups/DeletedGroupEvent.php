...
/**
 * A WorkGroup is deleted from the sistem
 *
 * Properties to set: $event: array (
 *		'type' => "Groups_DeletedGroup"
 *		'eventData' => String		the name of the workgroup deleted
 * )
 */

class DeletedGroupEvent implements ISimpleEventHandler {
	/**
