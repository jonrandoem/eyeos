...
/**
 * A list is deleted from the sistem
 *
 * Properties to set: $event: array (
 *		'type' => "People_DeletedList"
 *		'eventData' => array(
 *			'listId'	Integer		the id of the list deleted
 * 			'listName'	String		The name of the list deleted
 * )
 */

class DeletedListEvent implements ISimpleEventHandler {
	/**
