...
*/
function docviewer_application(checknum, pid, args) {
    var app = new eyeos.application.DocViewer(checknum, pid, args);
    app.drawGUI();
}

qx.Class.define('eyeos.application.DocViewer', {
    extend: eyeos.system.EyeApplication,

    construct: function(checknum, pid, args) {
        arguments.callee.base.call(this, 'docviewer', checknum, pid);
        if(args && args[0]) {
            this.__path = args[0];
        } 
    },
    ...
    members: {
        __path: null,
        drawGUI: function() {
            var mainWindow = new eyeos.ui.Window(this, 'DOC Viewer');
            ...
            var informationLabel = new qx.ui.basic.Label().set({
                value: '<center><b>' + tr('Converting Doc file...') + '</b></center>',
                rich: true,
                marginTop: 10,
                marginLeft: 230
            });
