...
/**
 *	eyeos.ui.toolbar.Button - Styling...
 *	Extending a qx.ui.toolbar.Button, to implement the eyeos
 *	look and feel behaviour.
 */
qx.Class.define('eyeos.ui.toolbar.Button', {
	...
	members: {
		...
		_setEyeosStyle: function(item, actions) {
			...
			if (item.cmd) {
				...
				this.addListener('execute', new Function('foo', 'this.actions.' + item.cmd + '(foo);'));
			}
