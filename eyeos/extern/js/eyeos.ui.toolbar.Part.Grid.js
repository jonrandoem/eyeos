 ...
 */
qx.Class.define('eyeos.ui.toolbar.Part.Grid', {
	extend : eyeos.ui.toolbar.Part,

	construct : function(groupName, father) {
		arguments.callee.base.call(this, groupName, father);
	...
	members: {
		...
		_setEyeosStyle: function(father) {
			this.base(arguments, father);
			this.getChildControl('container').setLayout(new qx.ui.layout.Canvas());
		},
		...
		addSeparator : function() {
			...
			separator.setAlignX('center');
			separator.setAlignY('middle');
			separator.setWidth(5);
			separator.setHeight(45);
			this.add(separator , {left:-3, top: 0});
		}
	}
});